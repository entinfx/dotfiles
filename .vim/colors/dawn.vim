...
highlight! CursorLine   cterm=NONE              ctermbg=249
highlight! CursorLineNr cterm=NONE ctermfg=255  ctermbg=62
highlight! LineNr       cterm=NONE ctermfg=235
...
highlight! PmenuSel     cterm=NONE ctermfg=233 ctermbg=212
highlight! PmenuSbar    cterm=NONE             ctermbg=246
highlight! PmenuThumb   cterm=NONE             ctermbg=253

highlight! Directory    cterm=NONE ctermfg=18
highlight! Normal       cterm=NONE ctermfg=233 ctermbg=247
highlight! Comment      cterm=NONE ctermfg=237
highlight! Constant     cterm=NONE ctermfg=124
highlight! Special      cterm=NONE ctermfg=19
highlight! Identifier   cterm=NONE ctermfg=56
highlight! Statement    cterm=NONE ctermfg=53
highlight! PreProc      cterm=NONE ctermfg=57
...
highlight! Todo         cterm=NONE ctermfg=255 ctermbg=23
